...
에르메스 에이전트(Hermes Agent) 업무 자동화: 챗봇 말고 나만의 AI 팀 만들기
...
에르메스 에이전트(Hermes Agent)를 기반으로 업무 자동화와 나만의 AI 팀을 만드는 실전 기록입니다. 하비를 메인 창구로 두고 방울이·뽀동이 같은 역할형 에이전트와 함께 일하며, AI 개인비서 워크플로우, 메모리·세션·스킬·프로필 경계, Slack·Obsidian·Google Workspace·WikiDocs 연동, 반복 업무의 체크리스트화와 복구 흐름까지 정리합니다.
