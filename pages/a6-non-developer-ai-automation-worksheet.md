...
더 좋은 요청:
회의록에서 결정된 것, 아직 미정인 것, 담당자별 액션 아이템, 다음 회의 전에 확인할 질문을 표로 정리해줘. 특정 사람이나 금액이 드러나는 부분은 일반화해줘.
```
...
- 특정 가능 정보나 보호해야 할 정보는 제거하거나 일반화해줘.
...
| 보호 정보 | 특정 가능 정보나 보호해야 할 정보가 제거되어 있다 |  |
