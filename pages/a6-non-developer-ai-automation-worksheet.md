...
더 좋은 요청:
회의록에서 결정된 것, 아직 미정인 것, 담당자별 액션 아이템, 다음 회의 전에 확인할 질문을 표로 정리해줘. 공개 문서로 옮길 수 없을 만한 고객명과 금액은 일반화해줘.
```
...
- 공개 문서로 옮길 수 없는 정보는 제거하거나 일반화해줘.
...
| 공개 가능한 노하우 | WikiDocs/블로그 | 비개발자 자동화 사례 |
...
5. 공개 가능한 운영 지식은 WikiDocs나 블로그로 일반화한다.
