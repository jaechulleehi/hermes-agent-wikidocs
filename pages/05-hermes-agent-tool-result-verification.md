...
작업 완료 보고에는 요약만 남기고, 반복 검증 절차는 Skill이나 체크리스트로 남긴다. 임시 진행 상태를 memory에 길게 남기지는 않는다.

## 다음 글

도구 실행과 검증 기준까지 잡았다면, 반복되는 절차는 6장의 [Hermes Agent Skill 운영](https://wikidocs.net/346235)으로 이어진다.
