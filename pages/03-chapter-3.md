...
[AI 개인비서 메인 창구](02-why-harvey-is-the-front-door.md)가 잡히면 다음 문제는 역할 분리다. 하비가 모든 일을 직접 처리하면 병목이 되고, 반대로 아무 기준 없이 위임하면 결과가 흩어진다. 그래서 3장에서는 조사형/정리형/실행형 에이전트를 왜 나눠야 하는지 정리한다.
