...
사용자가 “WikiDocs SEO를 다시 리뷰해줘”라고 요청하면 gateway는 Slack 요청을 Hermes Agent에게 전달한다. memory는 사용자가 짧은 보고와 자연스러운 한국어를 선호한다는 안정 기준을 제공한다. Skill은 WikiDocs 전자책 호환, SEO/GEO, 본문 링크, 검증/반영/공개 확인 흐름을 제공한다.
