...
![분명 파일은 있는데 왜 도구는 못 읽을까](../assets/why-tools-cannot-read-files-that-exist/og-card-final.png)
...
![존재와 열람 실패는 같은 문제가 아니다](../assets/why-tools-cannot-read-files-that-exist/article-figure-01-existence-vs-access.png)
...
![체감 문제는 레이어 문제로 분해해야 한다](../assets/why-tools-cannot-read-files-that-exist/article-figure-02-layer-translation.png)
...
![먼저 무엇을 확인해야 하는가](../assets/why-tools-cannot-read-files-that-exist/article-figure-03-check-order.png)
...
- [← 이전 글](03-why-same-harvey-feels-like-different-memory.md)
- [구축 과정 허브로 돌아가기](/build-journey/)
- [다음 글 →](05-why-google-workspace-integration-takes-longer-than-expected.md)
