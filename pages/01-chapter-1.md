...
처음에는 이 한 문장이면 충분해 보인다. 그런데 실제 업무에서는 금방 다음 문제가 붙는다. 어떤 자료를 믿을지 골라야 하고, 보고서로 다시 정리해야 하고, 이미지나 문서로 발행해야 하고, 마지막에는 링크와 결과물을 확인해야 한다. 한 번의 답변으로 끝나는 일이 아니라 여러 역할이 이어지는 일이다.
