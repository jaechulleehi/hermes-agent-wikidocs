...
요청은 단순히 문장을 늘리는 일이 아니었다. 전체 독자 흐름, 본문 안의 개념 링크, 기존 글 이전 상태, 공식 설명과 실제 운영 기준의 차이, 실제 케이스의 공개 범위를 함께 봐야 했다.
...
| 본문 링크 | 푸터 링크가 아니라 문장 안의 개념 연결을 봐야 함 |
| 공식 설명 | 기능 설명을 복사하지 말고 운영 패턴으로 번역해야 함 |
| 실제 케이스 | 기록을 그대로 옮기지 말고 독자용 사례로 바꿔야 함 |
| 공개 범위 | 독자가 몰라도 되는 내부값은 제거해야 함 |
| 발행 | 검증 후 공개 화면에서 다시 확인해야 함 |
...
- 기록용 디테일을 어디까지 독자용으로 바꿔야 하는지 뒤늦게 다시 정리한다.
...
| 공개 범위가 흔들린다 | 독자에게 필요한 이야기와 제거할 내부값의 경계 |
