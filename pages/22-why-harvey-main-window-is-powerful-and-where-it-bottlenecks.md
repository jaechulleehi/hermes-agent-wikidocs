...
요청은 단순히 문장을 늘리는 일이 아니었다. 전체 읽는 흐름, 본문 안의 개념 링크, 기존 글 이전 상태, 공식 설명과 실제 운영 기준의 차이, 실제 케이스의 공유 범위를 함께 봐야 했다.

이 요청은 한 에이전트가 즉흥적으로 글만 늘리면 실패한다. 메인 창구가 먼저 문제를 나눠야 한다.

| 요청 안의 층 | 메인 창구 판단 |
|---|---|
| 읽는 흐름 | 장별 여정과 다음 링크를 봐야 함 |
| 본문 링크 | 푸터 링크가 아니라 문장 안의 개념 연결을 봐야 함 |
| 공식 설명 | 기능 설명을 복사하지 말고 운영 패턴으로 번역해야 함 |
| 실제 케이스 | 기록을 그대로 옮기지 말고 읽기 쉬운 사례로 바꿔야 함 |
| 공유 범위 | 읽는 사람이 몰라도 되는 내부값은 제거해야 함 |
...
| 공유 범위가 흔들린다 | 읽는 사람에게 필요한 이야기와 제거할 내부값의 경계 |
