...
뽀동이에게 필요한 Skill은 글의 구조, 읽는 흐름, WikiDocs 전자책 호환성, SEO/GEO, 공개 문서 품질 검증이다. 그래서 뽀동이는 원고 작업 전 `wikidocs-github-ebook-pipeline` 같은 Skill을 보고, 결과를 반영하기 전 기술 검증과 독자 관점 검증을 함께 한다.
