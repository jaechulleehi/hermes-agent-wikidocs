...
WikiDocs 작업에서도 이 강점이 드러난다. “기존 글이 잘 옮겨졌는지”, “공식 설명이 빠지지 않았는지”를 보려면 문장만 읽어서는 부족하다. 현재 목차, 실제 페이지, 공개 화면, 이전 작업 기록을 함께 봐야 한다. 이때 조사형은 읽는 흐름을 쓰기보다 판단 재료를 정확히 모으는 역할을 맡는다.
