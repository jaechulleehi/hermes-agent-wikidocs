...
MCP 연동이 실패하는 이유는 설정이 어렵기 때문만은 아니다. 연결 후 무엇을 맡길지 정하지 않았기 때문이다. 도구가 연결되면 AI가 더 많은 일을 할 수 있지만, 그만큼 잘못된 쓰기 작업, 잘못된 공유, 보호해야 할 정보 노출 가능성도 커진다.
...
4. 보호해야 할 정보가 들어간 문서와 외부 공유 문서를 나눈다.
...
- 보호해야 할 정보가 들어간 문서를 별도 기준으로 다뤘는가?
- 반복 업무만 Skill로 남겼는가?
