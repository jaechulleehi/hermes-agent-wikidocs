...
SOUL.md는 “누구인가”에 가깝고, AGENTS.md는 “어떻게 일하는가”에 가깝다. USER.md는 “사용자가 무엇을 선호하는가”를 담는다. SOUL.md를 실제로 어떻게 작성하고 테스트할지는 [SOUL.md로 AI 에이전트 성격은 어떻게 정의할까](04-10-soul-md-agent-personality.md)에서 더 자세히 다룬다.
