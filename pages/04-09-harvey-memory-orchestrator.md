...
하비의 기억 오케스트레이션은 감으로 하는 분류가 아니다. 새 정보가 들어오면 사람/운영/프로젝트/절차/회상 중 어디에 가까운지 먼저 본다. 그다음 raw로 둘지, compiled note로 승격할지, skill로 만들지, WikiDocs로 공개 지식화할지를 판단한다.
...
| 공개 지식 | 독자에게 설명할 가치가 있나 | WikiDocs |
