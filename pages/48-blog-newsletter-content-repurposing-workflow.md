...
좋은 원본 글 하나는 블로그, 뉴스레터, Slack 공유문, 카드뉴스, 강의 자료로 다시 쓸 수 있다. 하지만 단순히 길이를 줄이는 것만으로는 재가공이 아니다. 채널마다 독자의 상태, 읽는 시간, CTA가 다르기 때문이다.
...
|---|---|
| 나쁜 예 | “이 글을 뉴스레터로 줄여줘” |
| 좋은 예 | “검색 독자용 블로그와 기존 구독자용 뉴스레터로 나누고, 각각 제목/첫 문단/CTA를 따로 만들어줘” |
