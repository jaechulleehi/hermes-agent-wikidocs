## 10장. Hermes Agent 실제 업무 자동화 케이스

에르메스 에이전트(Hermes Agent)로 실제 업무 자동화를 어떻게 만들 수 있을까? 10장은 그 질문에 답하는 사례 모음이다. Slack 요청, cron 조사, 역할형 에이전트 분업, GitHub/WikiDocs 발행이 어떻게 하나의 운영 흐름으로 이어지는지 보여준다.
...
각 케이스는 “이런 것도 했다”가 아니라 “어떤 운영 기준이 생겼는가”를 중심으로 읽어야 한다. 콘텐츠로 이어지는 케이스는 먼저 [WikiDocs/블로그/강의 콘텐츠 시스템](https://wikidocs.net/345911)의 채널 역할을 기준으로 읽으면 흐름이 더 잘 보인다. 좋은 케이스는 다음 다섯 가지를 남긴다.
