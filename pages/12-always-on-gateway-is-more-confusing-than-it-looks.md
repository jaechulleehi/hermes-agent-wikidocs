...
![always-on gateway는 왜 생각보다 자주 헷갈릴까](../assets/always-on-gateway-is-more-confusing-than-it-looks/og-card-final.png)
...
![status보다 실제 런타임이 먼저다](../assets/always-on-gateway-is-more-confusing-than-it-looks/article-figure-01-runtime-vs-status.png)
...
![always-on 혼선을 줄이는 점검 순서](../assets/always-on-gateway-is-more-confusing-than-it-looks/article-figure-02-check-order.png)
...
- [← 이전 글](11-how-to-use-obsidian-llm-wiki-in-real-operations.md)
- [구축 과정 허브로 돌아가기](/build-journey/)
- [다음 글 →](13-what-to-do-with-legacy-while-keeping-current-truth-clear.md)
