...
| 독자에게 필요한 교훈은 무엇인가 | 같은 전환을 할 때 먼저 점검할 질문 |

즉 공개할 것은 전환의 이야기와 판단 기준이다. 세부 설정값이나 사적인 운영 정보는 독자에게도 필요 없고, 운영 리스크만 만든다.
...
- 공개 사례에는 이야기와 기준만 남기고, 불필요한 내부 디테일은 제거해야 한다.
...
불필요한 내부 디테일이다. 공개 문서에는 왜 문제가 생겼고 어떤 운영 기준으로 해결했는지만 남겨야 한다.
