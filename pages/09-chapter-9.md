...
개인 운영에서는 “내가 아는 맥락”이 운영 기준이 될 수 있다. 하지만 조직에서는 그 맥락이 사람마다 다르다. 누군가는 Slack 대화만 보고 판단하고, 누군가는 GitHub 이력을 기준으로 삼고, 누군가는 WikiDocs에 올라온 공개 문서만 본다. 이 기준이 맞지 않으면 AI 에이전트 도입은 모델 성능과 무관하게 흔들린다.
...
개인 운영에서는 로이드가 하비에게 바로 말하고, 하비가 맥락을 해석하고, 필요하면 방울이/뽀동이/하망이에게 나눈다. 이 구조는 빠르다. 하지만 조직으로 가면 누가 요청했는지, 어떤 권한으로 실행하는지, 결과를 어디에 남길지, 누가 최종 승인할지까지 정해야 한다.
...
조직 도입은 큰 자동화보다 작은 반복 업무에서 시작하는 편이 좋다. 예를 들어 Daily Briefing Bot처럼 [cron](https://wikidocs.net/345926)이 조사 시작점을 만들고, 사람이 검토하고, 필요한 것만 콘텐츠나 제품 신호로 넘기는 흐름은 적합하다. 권한이 과하지 않고, 결과 검증이 가능하며, 기록 위치도 분명하기 때문이다.
...
조직 도입이 왜 자주 무너지는지는 [AI 에이전트 도입은 왜 운영에서 자주 무너질까](https://wikidocs.net/345922)에서 더 구체적으로 본다. 그다음 10장의 [Hermes Agent 실제 운영 케이스](https://wikidocs.net/345990)를 읽으면 앞 장의 기준이 실제 업무에서 어떻게 이어지는지 보인다.
