...
10장은 “AI 에이전트를 도입하면 일이 자동으로 좋아진다”는 기대를 낮추고, 실제 운영으로 이어지는 조건을 다룬다. 조직 도입의 핵심은 더 좋은 모델을 고르는 것이 아니라, 요청이 들어오고, [역할형 에이전트](https://wikidocs.net/345925)가 나뉘고, 결과가 검증되고, 지식으로 남는 흐름을 만드는 것이다.
