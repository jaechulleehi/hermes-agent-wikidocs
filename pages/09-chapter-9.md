...
Hermes Agent를 개인용 AI 개인비서로 쓰는 것과 조직의 업무 자동화 시스템으로 확장하는 것은 다른 문제다. [Hermes Agent](https://wikidocs.net/346055)를 조직에 도입하려면 역할, 권한, 기록, 검증, 책임자가 함께 정리되어야 한다. 개인은 하비 하나로도 많은 일을 처리할 수 있지만, 조직에서는 역할, 권한, 기록, 검증, 책임자가 함께 정리되어야 한다.

![조직 도입과 AI 에이전트 운영 확장 흐름](../assets/images/chapter-heroes/ch09-organization-agent-ops-scale-codex.webp)

개인 운영에서는 “내가 아는 맥락”이 운영 기준이 될 수 있다. 하지만 조직에서는 그 맥락이 사람마다 다르다. 누군가는 Slack 대화만 보고 판단하고, 누군가는 GitHub 이력을 기준으로 삼고, 누군가는 WikiDocs에 올라온 공유 문서만 본다. 이 기준이 맞지 않으면 AI 에이전트 도입은 모델 성능과 무관하게 흔들린다.

10장은 “AI 에이전트를 도입하면 일이 자동으로 좋아진다”는 기대를 낮추고, 실제 운영으로 이어지는 조건을 다룬다. 검색어로 말하면 AI 에이전트 도입, AI 에이전트 도입 사례, AI 에이전트 운영 사례에 해당하지만, 핵심은 더 좋은 모델을 고르는 것이 아니라 요청이 들어오고, [역할형 에이전트](https://wikidocs.net/345925)가 나뉘고, 결과가 검증되고, 지식으로 남는 흐름을 만드는 것이다.
...
조직 도입이 왜 자주 무너지는지는 [AI 에이전트 도입은 왜 운영에서 자주 무너질까](https://wikidocs.net/345922)에서 더 구체적으로 본다. 그다음 11장의 [Hermes Agent 실제 운영 케이스](https://wikidocs.net/345990)를 읽으면 앞 장의 기준이 실제 업무에서 어떻게 이어지는지 보인다.
