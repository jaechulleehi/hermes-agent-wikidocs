...
핵심 기준은 일의 성격이다. 짧은 판단, 우선순위, 최종 통합은 메인 창구가 직접 처리하는 편이 좋다. 반면 근거 수집, 긴 문서 정리, 파일 수정, 이미지 방향처럼 깊이가 필요한 일은 방울이, 뽀동이, 봉구, [하망이](https://wikidocs.net/345989) 같은 역할형 에이전트에게 맡기는 편이 안정적이다.
