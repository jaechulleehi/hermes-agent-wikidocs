...
좋은 이미지 제작은 프롬프트를 길게 쓰는 일이 아니다. 페이지가 말하려는 핵심을 압축하는 일이다. 뽀동이는 본문 메시지를 정리하고, 하망이는 그것을 시각 콘셉트로 바꾸고, 하비는 책 전체 흐름과 어긋나지 않는지 본다. 이 기준은 6장의 [하망이와 WikiDocs 본문 이미지를 만드는 법](https://wikidocs.net/345989)을 실제 요청으로 풀어낸 사례다.
