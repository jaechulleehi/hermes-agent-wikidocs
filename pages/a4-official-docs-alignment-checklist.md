...
이 점검표는 책의 설명을 [Hermes Agent 공식 문서](https://hermes-agent.nousresearch.com/docs/)와 맞춰 보기 위한 도구다. 한국어 책에서는 독자가 이해하기 쉽도록 운영 관점으로 풀어 쓰지만, 기능명/명령어/설정 경로/지원 플랫폼은 공식 문서와 맞아야 한다.
