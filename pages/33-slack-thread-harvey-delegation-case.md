...
| 검증 | H1, 이미지 경로, 링크, 중점 문자, 문체를 확인한다 |
...
### Slack 보고는 얼마나 자세해야 하나요?

Slack은 짧게, 원본 문서는 자세히가 좋다. 완료 보고는 `완료/남음/다음` 정도로 충분하고, 자세한 절차는 WikiDocs나 GitHub 원본에 남긴다.
