...
반대로 호출 규칙이 없으면 봇들이 동시에 답하고 스레드가 시끄러워진다. 8장에서 정리한 [멀티봇 스레드 규칙](https://wikidocs.net/345913)은 이 문제를 줄이기 위한 운영 장치다. 콘텐츠 요청이라면 이 분배는 결국 [방울이 확장조사와 뽀동이 글쓰기 흐름](https://wikidocs.net/345993)으로 이어진다.
