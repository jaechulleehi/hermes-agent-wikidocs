...
## 2.10 10장: 조직 도입과 AI 에이전트 운영 확장

10장은 개인 AI 팀이 조직 운영으로 확장될 때의 기준을 설명한다.
...
## 2.11 11장: Hermes Agent 실제 운영 케이스

11장은 앞 장의 개념을 실제 흐름으로 보여주는 장이다. 각 케이스에서 관련 개념 장으로 역링크를 둔다.
